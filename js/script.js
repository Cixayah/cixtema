...
class CustomerManager {
    ...
    renderCustomerCard(customer) {
        ...
        return `
<div class="customer-card p-6 sm:p-8 rounded-2xl transition-all duration-300 hover:scale-[1.02]">
  <div class="flex flex-col md:flex-row md:items-center md:justify-between">
    <div class="flex-1">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 text-center md:text-left">
      
        <div class="space-y-4 sm:space-y-5 border border-gray-600 rounded-lg p-4">
          <div>
            <h4 class="text-xl sm:text-2xl font-bold mb-2" style="color: var(--dracula-purple);">
              <i class="fas fa-user mr-3"></i>${highlightedName}
            </h4>
            <p class="text-sm sm:text-base" style="color: var(--dracula-comment);">
              ID: ${customer.id}
            </p>
          </div>
          <div class="space-y-2 sm:space-y-3">
            <p class="text-sm sm:text-base">
              <i class="fas fa-phone mr-3" style="color: var(--dracula-cyan);"></i>
              <span style="color: var(--dracula-foreground);">${customer.phone || ''}</span>
            </p>
            <p class="text-sm sm:text-base">
              <i class="fas fa-envelope mr-3" style="color: var(--dracula-cyan);"></i>
        ...
        <div class="space-y-4 sm:space-y-5 border border-gray-600 rounded-lg p-4">
          <h5 class="font-semibold text-base sm:text-lg" style="color: var(--dracula-green);">
            <i class="fas fa-map-marker-alt mr-3"></i>Endereço
          </h5>
          <div class="space-y-2 sm:space-y-3">
            <p class="text-sm sm:text-base" style="color: var(--dracula-foreground);">
              ${customer.address || ''}, ${customer.number || ''}
            </p>
            <p class="text-sm sm:text-base" style="color: var(--dracula-yellow);">
              <span style="color: var(--dracula-comment);">Bairro:</span>
              ${customer.neighborhood || ''}
            </p>
            <p class="text-sm sm:text-base" style="color: var(--dracula-pink);">
        ...
        <div class="space-y-4 sm:space-y-5 border border-gray-600 rounded-lg p-4">
          <h5 class="font-semibold text-base sm:text-lg" style="color: var(--dracula-yellow);">
            <i class="fas fa-id-card mr-3"></i>Documentos
          </h5>
          <div class="space-y-2 sm:space-y-3">
            <p class="text-sm sm:text-base">
            ...
            <p class="text-sm sm:text-base">
              ...
              <span style="color: var(--dracula-foreground);"> ${highlightedCPF}</span>
                ...
                <div class="flex flex-col gap-4 md:ml-6 mt-4 md:mt-0 justify-center md:justify-start">
                <button onclick="window.customerManagerInstance.editCustomer(${customer.id})" 
                        class="btn-primary px-4 py-2 rounded-lg font-semibold transition-all duration-200 hover:scale-105 text-base md:text-lg">
                    <i class="fas fa-edit mr-3"></i>Editar
                </button>
                <button onclick="window.customerManagerInstance.showDeleteModal(${customer.id})" 
                        class="btn-danger px-4 py-2 rounded-lg font-semibold transition-all duration-200 hover:scale-105 text-base md:text-lg">
                    <i class="fas fa-trash mr-3"></i>Excluir
                </button>
                </div>
