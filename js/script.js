// app.js - Sistema CRUD de clientes

class customerManager {
    constructor() {
        this.apiUrl = 'http://localhost:3000/customers';
            ...
            <div class="customer-card p-6 rounded-2xl transition-all duration-300 hover:scale-[1.02]">
                <div class="flex items-start justify-between">
                    ...
                    <div class="flex flex-col gap-3 ml-6">
                        <button onclick="customerManager.editcustomer(${JSON.stringify(customer).replace(/"/g, '&quot;')})" 
                                class="btn-primary px-6 py-3 rounded-lg font-medium transition-all duration-200 hover:scale-105">
                            <i class="fas fa-edit mr-2"></i>Editar
                        </button>
                        <button onclick="customerManager.showDeleteModal(${customer.id})" 
